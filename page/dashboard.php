...
<body class="bg-gray-50">
    ...
    <aside id="sidebar" class="desktop-sidebar w-64 bg-gradient-to-br from-bright-green via-green-light to-green-dark shadow-xl border-r border-gray-200 transform -translate-x-full xl:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col">
        ...
        <nav class="flex-1 px-4 pb-4 space-y-2">
            <a href="dashboard.php?view=dashboard/index" class="flex items-center px-4 py-3 rounded-lg text-white hover:bg-white hover:bg-opacity-20 hover:text-white transition-colors duration-200">
                <span class="mr-3"><i class="fa-solid fa-chart-pie"></i></span> Dashboard
            </a>
            <a href="dashboard.php?view=transaksi" class="flex items-center px-4 py-3 rounded-lg text-white hover:bg-white hover:bg-opacity-20 hover:text-white transition-colors duration-200">
                <span class="mr-3"><i class="fa-solid fa-cart-shopping"></i></span> Transaksi
            </a>
            <a href="dashboard.php?view=master/customer/index" class="flex items-center px-4 py-3 rounded-lg text-white hover:bg-white hover:bg-opacity-20 hover:text-white transition-colors duration-200">
                <span class="mr-3"><i class="fa-solid fa-users"></i></span> Customer
            </a>
            <a href="dashboard.php?view=master/category/index" class="flex items-center px-4 py-3 rounded-lg text-white hover:bg-white hover:bg-opacity-20 hover:text-white transition-colors duration-200">
                <span class="mr-3"><i class="fa-solid fa-layer-group"></i></span> Category
            </a>
            <a href="dashboard.php?view=master/product/index" class="flex items-center px-4 py-3 rounded-lg text-white hover:bg-white hover:bg-opacity-20 hover:text-white transition-colors duration-200">
                <span class="mr-3"><i class="fa-solid fa-boxes-packing"></i></span> Product
            </a>
            <a href="dashboard.php?view=master/admin/index" class="flex items-center px-4 py-3 rounded-lg text-white hover:bg-white hover:bg-opacity-20 hover:text-white transition-colors duration-200">
                <span class="mr-3"><i class="fa-solid fa-user-tie"></i></span> Admin
            </a>
            <a href="dashboard.php?view=master/laporan/index" class="flex items-center px-4 py-3 rounded-lg text-white hover:bg-white hover:bg-opacity-20 hover:text-white transition-colors duration-200">
                <span class="mr-3"><i class="fa-solid fa-database"></i></span> Laporan
            </a>
            <div class="border-t border-white border-opacity-30 my-4"></div>
            <a href="../../actions/logout.php" class="flex items-center px-4 py-3 rounded-lg text-white hover:bg-red-500 hover:bg-opacity-20 hover:text-white transition-colors duration-200">
